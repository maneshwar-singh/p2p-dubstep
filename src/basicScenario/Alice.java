...
public class Alice implements KPListener {
  ...
  public static void main(String[] args) throws SharkKBException, IOException, SharkSecurityException, SharkProtocolNotSupportedException {
    ...
    SemanticTag shark = aliceKB.createSemanticTag("Shark", "http://www.google.net/");

    // Create a peer to describe ourselves
    String[] aliceAddr = new String[1];
    aliceAddr[0] = "tcp://localhost:7070";

     PeerSemanticTag alice = aliceKB.createPeerSemanticTag("Alice", "http://www.google.net/alice.html", aliceAddr);
    ...
    PeerSemanticTag bob = aliceKB.createPeerSemanticTag("Bob", "http://www.sharksystem.net/bob.html", "tcp://localhost:7072");
